...
#define MATCH_U24(type, value) {type, {(u8)(value), (u8)((value) >> 8), (u8)((value) >> 16)}}
#define MATCH_U16(type, v1, v2) {type, {(u8)(v1), (u8)((v1) >> 8), (u8)(v2)}}
#define MATCH_U8(type, v1, v2, v3) {type, {(u8)(v1), (u8)(v2), (u8)(v3)}}
