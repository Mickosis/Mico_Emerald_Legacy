...
static void SetPartyMonFieldSelectionActions(struct Pokemon *mons, u8 slotId)
{
    ...
    // If Mon can learn HM02 and action list consists of < 5 moves, add FLY to action list
    ...
    // If Mon can learn HM05 and action list consists of < 5 moves, add FLASH to action list
